...
export const routes = [
  ...
  { name: 'product-list', path: '/products/list', component: tableLightProduct, display: 'Product', icon: 'list' , hidden:false},
  { name: 'modifier-list', path: '/modifier/list', component: tableLightModifier, display: 'Modifier', icon: 'list', hidden:false },
  { name: 'category-list', path: '/cateogry/list', component: tableLightCategory, display: 'Category', icon: 'list', hidden:false },
  { name: 'pos', path: '/merchant/pos', component: posComponent, display: 'POS', icon: 'list', hidden:false },
